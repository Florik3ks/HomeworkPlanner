...
namespace HomeworkPlanner {
    partial class Form1 {
        ...
        private void InitializeComponents () {
            ...
            username.Height = 50;
            username.TabIndex = 1;
            username.Text = Config.portalUsername;
            ...
            Button showHoursButton = new Button ();
            showHoursButton.BackColor = Config.showTimetableLessonTimes ? Color.LightGreen : Color.Salmon;
            showHoursButton.Dock = DockStyle.Top;
            showHoursButton.Text = "Stunden beim Stundenplan anzeigen";
            showHoursButton.Height = 60;
            showHoursButton.Click += ShowPlanHours;

            p4.Controls.Add (showHoursButton);
        ...
        private void ShowPlanHours (object sender, EventArgs e) {
            Button b = sender as Button;
            Config.showTimetableLessonTimes = !Config.showTimetableLessonTimes;
            Config.SaveConfig ();
            b.BackColor = Config.showTimetableLessonTimes ? Color.LightGreen : Color.Salmon;
            Timetable.ShowPlan (timetablePanel, true);
        }
    }
}